...
Math Table is a plugin for the [Glyphs font editor](http://glyphsapp.com/) to support OpenType [MATH](https://docs.microsoft.com/en-us/typography/opentype/spec/math) table.
